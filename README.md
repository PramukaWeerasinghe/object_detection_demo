...
Easy way: run [this Colab Notebook](https://colab.research.google.com/github/PramukaWeerasinghe/object_detection_demo/blob/master/tensorflow_object_detection_training_colab.ipynb).
